                ...
                if (rowNum > 5 && (rowNum < (physicalNumberOfRows - 1))) {
                    ...
                    while (cellsInRow.hasNext()) {
                        ...
                        switch (columnIndex) {
                            ...
                            case 1:
                                cajaChica.setTipoDocumento(currentCell.getStringCellValue());
                                break;
                            ...
                            case 2:
                                ...
                                cajaChica.setSerie(arrSerieNumero[0]);
                            ...
                            case 5:
                                cajaChica.setNumeroDocumento(currentCell.getStringCellValue());
                                break;
